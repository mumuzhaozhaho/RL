...
class TD3(object):
	def __init__(
		...
		self.max_action = max_action #最大动作，使得tanh输出变为期望区间
		self.gamma = cfg.gamma  #奖励折扣
		self.lr = cfg.lr  #延迟更新学习率
		self.policy_noise = cfg.policy_noise   #噪声值
		self.noise_clip = cfg.noise_clip  #噪声门限
		self.policy_freq = cfg.policy_freq #  延迟更新频率
